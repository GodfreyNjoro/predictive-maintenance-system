  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await signIn("credentials", {
        username,
        email: username, // Support both username and email login
        password,
        redirect: false,
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
      ...
      <div className="p-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-white font-semibold text-xl">System Failure</span>
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 mt-2">Sign in to access the predictive maintenance system</p>
            </div>
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            System Failure Predictive Maintenance System
          </p>
        </motion.div>
      </div>
    </div>
